...
public class FrmLogin extends JFrame {
	...
	void registrar() {
		...
		// 2. buscar si existe un Usuario según los datos ingresados
		EntityManagerFactory fabrica = Persistence.createEntityManagerFactory("jpa_sesion01");
		EntityManager em = fabrica.createEntityManager();
		
		// Usuario u = em.find(Usuario.class, ID);  // solo busca según ID o PK
		...
		try {
			...
			// 3. mostrar los mensaje de éxito o de error.
